...
if(username !== undefined) {
  ...
  logger('𝐁𝐚̣𝐧 đ𝐚𝐧𝐠 đ𝐮̛𝐨̛̣𝐜 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐛𝐨𝐭 𝐨̛̉ 𝐥𝐢𝐧𝐤: ' + urlRepl, '[ 𝐓𝐨̛́ đ𝐚𝐧𝐠 𝐜𝐡𝐞𝐜𝐤 𝐡𝐨𝐬𝐭 ]');
  if(process.env.REPLIT_CLUSTER == 'hacker') logger('𝐁𝐚̣𝐧 đ𝐚𝐧𝐠 đ𝐮̛𝐨̛̣𝐜 𝐡𝐨𝐚̣𝐭 đ𝐨̣̂𝐧𝐠 𝐛𝐨𝐭 𝐱𝐮𝐲𝐞̂𝐧 𝐬𝐮𝐨̂́𝐭, 𝐤𝐡𝐨̂𝐧𝐠 𝐝𝐮̛̀𝐧𝐠. 𝐂𝐡𝐢̉ 𝐝𝐮̛̀𝐧𝐠 𝐤𝐡𝐢 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐝𝐢𝐞!', '[ 𝐓𝐨̛́ đ𝐚𝐧𝐠 𝐜𝐡𝐞𝐜𝐤 𝐡𝐨𝐬𝐭 ]');
  logger('𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐛𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐭𝐡𝐞̂̉ 𝐤𝐞́𝐨 𝐝𝐚̀𝐢 𝐭𝐡𝐨̛̀𝐢 𝐠𝐢𝐚𝐧 𝐡𝐨𝐚̣𝐭 đ𝐨̣̂𝐧𝐠 𝐜𝐮̉𝐚 𝐛𝐨𝐭 đ𝐮̛𝐨̛̣𝐜, 𝐯𝐢̀ 𝐯𝐚̣̂𝐲 𝐦𝐢̀𝐧𝐡 𝐬𝐞̃ 𝐠𝐢𝐮́𝐩 𝐛𝐚̣𝐧!', '[ 𝐓𝐨̛́ đ𝐚𝐧𝐠 𝐜𝐡𝐞𝐜𝐤 𝐡𝐨𝐬𝐭 ]');
  //connectUptime(urlRepl, config.name);
};
/*async function connectUptime(url) {
  try {
    const res = (await axios.get(`https://api-0703.0703-opa.repl.co/uptimerobot/create?url=${url}&key=${username}&monitor=${config.name}`)
		logger('Đ𝐚̃ 𝐡𝐨𝐚̀𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐤𝐞́𝐨 𝐝𝐚̀𝐢 𝐭𝐡𝐨̛̀𝐢 𝐠𝐢𝐚𝐧 𝐛𝐨𝐭 𝐡𝐨𝐚̣𝐭 đ𝐨̣̂𝐧𝐠!', '[ 𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 ]');
	}
	catch {
		logger('Server Uptime gặp sự cố, không thể bật uptime cho bạn!', '[ 𝐏𝐡𝐚́𝐭 𝐡𝐢𝐞̣̂𝐧 𝐫𝐚 ]');
  }	
};*/
}, 1000)
...
chalkAnimation.rainbow('\n●───────────────────────────────────────────●\n⇒ 𝐀𝐝𝐦𝐢𝐧: 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡\n⇒ 𝐅𝐢𝐥𝐞 𝐁𝐨𝐭 𝐍𝐚̀𝐲 Đ𝐮̛𝐨̛̣𝐜 𝐌𝐢̀𝐧𝐡 𝐌𝐨𝐝 𝐋𝐚̣𝐢 Đ𝐞̂̉ 𝐍𝐨́ 𝐇𝐨𝐚̀𝐧 𝐂𝐡𝐢̉𝐧𝐡 𝐍𝐡𝐚̂́𝐭 𝐂𝐨́ 𝐓𝐡𝐞̂̉\n⇒ 𝐅𝐢𝐥𝐞 Đ𝐮̛𝐨̛̣𝐜 𝐂𝐚̣̂𝐩 𝐍𝐡𝐚̂́𝐭 𝐕𝐚̀𝐨 𝐋𝐮́𝐜: 𝟎𝟎:𝟒𝟎:𝟎𝟑 𝐱 𝟏𝟕/𝟎𝟔/𝟐𝟎𝟐𝟑\n⇒ 𝐍𝐞̂́𝐮 𝐂𝐨́ 𝐒𝐮̛̉ 𝐃𝐮̣𝐧𝐠 𝐅𝐢𝐥𝐞 𝐕𝐮𝐢 𝐋𝐨̀𝐧𝐠 𝐊𝐡𝐨̂𝐧𝐠 𝐓𝐡𝐚𝐲 𝐂𝐫𝐞 𝐂𝐮̉𝐚 𝐍𝐨́. 𝐗𝐢𝐧 𝐂𝐚̉𝐦 𝐎̛𝐧!\n●───────────────────────────────────────────●\n');
    ...
    try {
        try {
          ...
          where: filter  
            ...
            logger.loader('𝐊𝐞̂́𝐭 𝐧𝐨̂́𝐢 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 𝐝𝐮̛̃ 𝐥𝐢𝐞̣̂𝐮 𝐀𝐍𝐓𝐈 𝐒𝐄𝐓𝐓𝐈𝐍𝐆', '[ 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡 ]');
        }
        catch (error) {
            global.client.loggedMongoose = false;
            logger.loader('𝐊𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐞̂̉ 𝐤𝐞̂́𝐭 𝐧𝐨̂́𝐢 𝐝𝐮̛̃ 𝐥𝐢𝐞̣̂𝐮 𝐀𝐍𝐓𝐈 𝐒𝐄𝐓𝐓𝐈𝐍𝐆', '[ 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡 ]');
            console.log(error);
        }
        ...
        logger(global.getText('mirai', 'successConnectDatabase'), '[ 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡 ]');
        const botData = {};
        botData.models = models
        onBot(botData);
    } catch (error) { logger(global.getText('mirai', 'successConnectDatabase', JSON.stringify(error)), '[ 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡 ]'); }
})();
process.on('unhandledRejection', (err, p) => {});
//𝐁𝐨𝐭 đ𝐮̛𝐨̛̣𝐜 𝐦𝐨𝐝 𝐥𝐚̣𝐢 𝐛𝐨̛̉𝐢 𝐂𝐚𝐨 𝐓𝐢𝐞̂́𝐧 𝐓𝐡𝐚̀𝐧𝐡