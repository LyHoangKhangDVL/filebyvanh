...
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: đéo bt
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧: đéo bt
👫 𝐆𝐮: đéo bt
💻 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: 0812320307
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/100064829510922 `,
  }break;
        case "13": {
          const moment = require("moment-timezone");
    const request = require("request")
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100064829510922) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
