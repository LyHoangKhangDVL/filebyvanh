...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	if (isNaN(num)) msg = "Hãy nhập 1 con số mà bạn muốn";
      ...
      msg += `\n✎﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏`
			...
			msg += "\n\n╭──────╮\n    Reply \n╰──────╯ tin nhắn theo số để xem thông tin chi tiết lệnh và cách0KyqYec sử dụng lệnh";
		}
	}
	const axios = require('axios');
	const fs = require('fs-extra');
	const img = [ "https://i.ibb.co/rZ7zR1V/t-i-xu-ng-1.jpg","https://i.ibb.co/FH8fm7v/7535da57-b81b-4372-98f2-5195bd7e1dd8.jpg","https://i.ibb.co/XtzmD2n/Pain-pfp.jpg","https://i.ibb.co/nkNKtqw/image.jpg","https://i.ibb.co/vLQK2VL/t-i-xu-ng.jpg","https://i.ibb.co/kSTF79F/Pain.jpg","https://i.ibb.co/L63Ghxq/pein.jpg","https://i.ibb.co/0srC9QH/image.png","https://i.ibb.co/T0bnXhK/image.jpg","https://i.ibb.co/QHXKQ6J/Pain-yahiko.jpg"]
...
module.exports.run = async function({ api, event, args }) {
	...
	const fs = require('fs-extra');
	const imgP = []
	const img = ["https://media.giphy.com/media/sehCQ2rUrb9C7tHc7d/giphy.gif","https://media.giphy.com/media/M07A4JQq94wU4ppEhh/giphy.gif","https://media.giphy.com/media/w8OIEJ2euhzBh1b9km/giphy.gif","https://media.giphy.com/media/MtTj5HeoaTqSRZg9fW/giphy.gif","https://media.giphy.com/media/VOPj2CY2Oo3KpcNUpi/giphy.gif","https://media.giphy.com/media/TCmAyRYTLhqRmBkXfC/giphy.gif","https://media.giphy.com/media/kcwWQmsrnPKKtvDmMF/giphy.gif","https://media.giphy.com/media/BXObdmuDNInOjfDca6/giphy.gif","https://media.giphy.com/media/9588gDhI0rantWes2P/giphy.gif","https://media.giphy.com/media/32DbOUdGMaxgT3fS2J/giphy.gif","https://media.giphy.com/media/TmgwesSHj2BxRabmHp/giphy.gif"]
	var path = __dirname + "/cache/menu.gif"
	var rdimg = img[Math.floor(Math.random() * img.length)]; 
