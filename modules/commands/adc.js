...
url: (await global.nodemodule["axios"]('https://phong-canh.huy101.repl.co/hon')).data.data,
method: "GET",
responseType: "stream"
})).data
  ...
  const picture = (await axios.get(`https://i.imgur.com/Dd1bPSD.jpeg`, { responseType: "stream"})).data
    var name = args[0];
    if (type == "message_reply") {
        var text = messageReply.body;
    }
    if(!text && !name) return api.sendMessage({body: '→ 𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝗿𝗲𝗽𝗹𝘆 𝗹𝗶𝗻𝗸 𝗺𝘂𝗼̂́𝗻 𝗮́𝗽 𝗱𝘂̣𝗻𝗴 𝗰𝗼𝗱𝗲 𝗵𝗼𝗮̣̆𝗰 𝗴𝗵𝗶 𝘁𝗲̂𝗻 𝗳𝗶𝗹𝗲 đ𝗲̂̉ 𝘂𝗽 𝗰𝗼𝗱𝗲 𝗹𝗲̂𝗻 𝗽𝗮𝘀𝘁𝗲𝗯𝗶𝗻!', attachment: (picture)}, threadID, messageID);
    if(!text && name) {
        ...
        axios.get(url[0]).then(i => {
            ...
            fs.writeFile(
                ...
                function (err) {
                    ...
                    api.sendMessage({body: `[ 𝗣𝗔𝗦𝗧𝗘𝗕𝗜𝗡 ] → Đ𝗮̃ 𝗮́𝗽 𝗱𝘂̣𝗻𝗴 𝗰𝗼𝗱𝗲 𝘃𝗮̀𝗼 ${args[0]}.js, 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝗹𝗼𝗮𝗱 đ𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴!`, attachment: (picture)}, threadID, messageID);
                }
            );
        })
    }
    ...
    if (url[0].indexOf('buildtool') !== -1 || url[0].indexOf('tinyurl.com') !== -1) {
        ...
        request(options, function (error, response, body) {
            if (error) return api.sendMessage({body: '[ 𝗣𝗔𝗦𝗧𝗘𝗕𝗜𝗡 ] → 𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝗰𝗵𝗶̉ 𝗿𝗲𝗽𝗹𝘆 𝗹𝗶𝗻𝗸 (𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗵𝘂̛́𝗮 𝗴𝗶̀ 𝗸𝗵𝗮́𝗰 𝗻𝗴𝗼𝗮̀𝗶 𝗹𝗶𝗻𝗸)', attachment: (picture)},  threadID, messageID);
            ...
            load('.language-js').each((index, el) => {
                ...
                fs.writeFile(`${__dirname}/${args[0]}.js`, code, "utf-8",
                    function (err) {
                        ...
                        return api.sendMessage({body: `[ 𝗣𝗔𝗦𝗧𝗘𝗕𝗜𝗡 ] → Đ𝗮̃ 𝘁𝗵𝗲̂𝗺 𝗰𝗼𝗱𝗲 𝗻𝗮̀𝘆 𝘃𝗮̀𝗼 "${args[0]}.js", 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝗹𝗼𝗮𝗱 đ𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴!`, attachment: (picture)}, threadID, messageID);
                    }
                );
            });
        });
