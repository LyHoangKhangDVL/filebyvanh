...
function _0x382e() {
    const _0xea349f = ['.gìf', 'leaveGif', 'floor', '78064RBKQGj', '85tUCdFH', 'customLeave', 'onLoad', '𝙩ự 𝙧ờ𝙞', 'nodemodule', '36ZwKWwf', '𝙗ị 𝙦𝙪ả𝙣 𝙩𝙧ị 𝙫𝙞ê𝙣 đá', '245udigqB', 'config', 'sendMessage', 'HĐGN', '130hnCFLX', 'leftParticipantFbId', '109299XNBCrO', 'author', 'randomgif', '1.0.0', 'Càng sống lâu bao nhiêu, {name} càng nhận ra hiện thực này chỉ toàn đau khổ, chịu đựng và trống rỗng vì vậy rời đi trong im lặng là lẽ thường tình của con cháu madara ta ', 'getCurrentUserID', 'undefined', 'data', '41960JIOJoP', '36ZcDwMy', 'threadData', 'logMessageData', 'log:unsubscribe', 'path', 'getNameUser', 'cache', 'exports', 'replace', 'run', '9111mqPxia', 'random', '248652jAXEzJ', '2846040HCHaek', '2551571QKMSbP', 'length'];
    _0x382e = function () {
        return _0xea349f;
    };
    return _0x382e();
